...
| 5. Jobs — BOX_FE/BOX_ACC internal batch analogue | `branch-config-agent`, Phase 1 | Blocked on `box-fe-acc-batch-runtime.md` landing (see `job-chains/README.md`) — can't be scoped more precisely than "propose from analogue" until then. |
