...
| A3 | Get product and book scope from a named SME, in writing — instruments chosen from **BOX's live catalogue**, not from the branch's GBO instrument config | Scope statement, attributed | Yes |
