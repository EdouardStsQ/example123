...
**Runs between mining and findings review, only when `GBO_SOURCE` and `TARGET_ENV` differ, and — since
2026-09-18 — only once per environment pair rather than once per run.**
