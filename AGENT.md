...
| `sigom-box-fe-configs-agent` | **The BOX FE walk** — the 13-step gated config walk producing runnable FE SQL (gates 0a–0e, its own kickoff prompt, its own run folder). This is what executes the FE half of W2 today |
