...
> | Affected | Change |
> |---|---|
> | `PRODUCT_BOOK_SCOPE` | Instruments are chosen from **BOX's live catalogue**, by a named SME — not derived from the branch's GBO instrument configuration. The menu is the BOX FE Processed Instruments catalogue in [`box-data-model.md`](../../docs/reference/box-data-model.md) |
