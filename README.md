...
| job-chains/box-fe-acc-batch-runtime.md | reference | **FE half imported (2026-09-16)** — the nine-step FE batch event-group sequence with PKs, its two before-batch prerequisites, and the procedure order inside groups `2629.65`/`2630.65`. The **BOX_ACC** batch and the FE→ACC barrier are still not documented |
