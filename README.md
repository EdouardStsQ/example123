...
| `NY_SCH/tier1-rehearsal/` | `sigom-box-fe-configs-agent` | **Active 2026-09-16** — Tier 1 rehearsal in symbolic-PK mode, to validate that the walk emits correct, ordered, well-formed SQL while Tier 2 access is pending. Produces a validated *shape*; its values are Tier 1 and must not be carried to Tier 2. See the kickoff's *Active mode* section |
