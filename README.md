...
| `reference/` | Facts you look something up in — DB tables, queries, API specs, field glossaries | Dense, no narrative, kept literally correct |
...
| branch-config/agent-architecture.md | reference | The onboarding workflow (Build vs. Validate) and the four agents that run it — see `agents/` |
