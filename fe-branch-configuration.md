...
| Accrual | `T_BOX_ENGACCRCONF_S` | `T_PGT_ENGACCRCONF_S` | configuration × instrument: fee/interest first-day selectors, common basis, trigger/residual, interval, basis. **Also the branch's instrument enumeration** — see below | `confirmed` |
