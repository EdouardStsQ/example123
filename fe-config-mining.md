...
**Then:** `python3 scripts/evidence_to_sql.py list 01-evidence/Q-04c-quote-ref-column-gbo.csv FK_BS` — the
output goes into the script **unchanged**. Worked SQL: the config template, step 4.
