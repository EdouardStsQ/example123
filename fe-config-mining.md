...
Nothing in the walk is valid until all four gates pass. **Revised 2026-09-16:** Q-G2 is *narrowed* to
its first level — see that section. Q-G3 and Q-G4 remain the two blocking unknowns for any real run.
