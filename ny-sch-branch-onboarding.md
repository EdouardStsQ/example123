...
5. **Explicit product scope for NY_SCH**, from the business/FO SME — never inferred from what
   ...
   **↳ Now answerable, 2026-09-17** `[confirmed: DB via Edouard]` — the "same set as SLB" hypothesis
   ...
   Note this is **nine**, where the query catalogue's older calibration line records seven for SLB; see
   the discrepancy flag on Q-05. Confirming the set does **not** authorise copying SLB's accrual values.
