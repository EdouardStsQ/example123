...
- **A hard-coded `35000126.65` / `35001566.65` / `35001114.65`** — Tier 1 observations, unverified in
  Tier 2. Bind them from Q-G6, as substitution variables in a deferred-verification run.
